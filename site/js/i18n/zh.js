...
window.CRZ_I18N = {
  ...
  method: [
    { n: '驗證', jp: '', d: '動手之前，先和可能會用的人聊聊，確認我們的假設，講好做到什麼算成功。' },
    { n: '打造', jp: '', d: '由一個小而有經驗的團隊負責設計和開發，從一開始就用可以直接上線的基礎來做。' },
    { n: '上線', jp: '', d: '先推出一個把一件事做好的版本，看大家怎麼用，再把礙事的地方修掉。' },
    { n: '改善', jp: '', d: '根據真實的使用情況，持續改進速度、無障礙、文案和操作細節。' },
  ],
  ui: {
    wipBadge: '開發中',
    indexLabel: '作品索引',
